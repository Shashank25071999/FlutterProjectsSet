...
class AuthState extends State<Auth> {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    ...
    http.Response response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyChuWZuTHiJHFVbxwqJiZrv6y4OGi-NzPA',
    ...
    if (responsedata.containsKey('idToken')) {
      if (responsedata['email'] == 'sahai@gmail.com') {
        haserror = true;
  ...
  Future<Map<String, dynamic>> signup(String email, String password) async {
    ...
    http.Response response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyChuWZuTHiJHFVbxwqJiZrv6y4OGi-NzPA',
